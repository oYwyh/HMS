    ...
    <div class="search">
        <table>
            ...
            if(isset($_POST['search'])) {
                ...
                $sql = "SELECT * FROM tbl_appointment WHERE patient_name='$patient_name' AND
                (doctor_name LIKE '%$search%' OR specialization LIKE '%$search% 'OR appointment_date LIKE '%$search%')";
                        ...
                        while($rows=mysqli_fetch_assoc($res)) {
                            ...
                            <tr class="table-info">
                                ...
                                <th><?php  
                                    ...
                                    ; ?></th>   
                                <th class="actions">
                                    <a href="<?php echo SITEURL.'admin/delete-doctor.php?id='.$id?>" class="failed">Cancel</a>
                                </th>
                            </tr>
                            <?php
                        }
