...
<script>
    ...
    const updateAbleInp = document.querySelectorAll('[data-updateable="input"]')
    const updateAbleLabel = document.querySelectorAll('[data-updateable="label"]')
    const prescription = document.querySelectorAll('.prescription');
    const list = document.querySelectorAll('.row-list .list')
    ...
    updateBtn.addEventListener('click', (e) => {
        ...
        // })
        updateAbleInp.forEach(inp => {
            inp.removeAttribute('readonly')
        })
        updateAbleLabel.forEach(label => {
            label.classList.add('updateable_label')
        })
        prescription.forEach(presc => {
            while (presc.firstChild) {
                presc.firstChild.remove()
            }
        })
        setTimeout(() => {
